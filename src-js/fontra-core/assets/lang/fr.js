...
export const strings = {
  ...
  "action.add-guideline-between-points": "Ajouter un guide entre des points",
  ...
  "action.copy-glyphname.plural": "Copier les noms de glyphes",
  "action.cut": "Couper",
  ...
  "action.glyph.convert-curves-to-quadratic-1": "en Quadratique (1 point de controle)",
  "action.glyph.convert-curves-to-quadratic-2": "en Quadratique (2 points de controle)",
  "action.glyph.convert-curves-to-quadratic-3": "en Quadratique (3 points de controle)",
  "action.glyph.convert-curves-to-quadratic-4": "en Quadratique (4 points de controle)",
  "action.glyph.convert-curves-to-quadratic-5": "en Quadratique (5 points de controle)",
  ...
  "axes.properties.hidden": "Axes cachés",
  "axes.range": "Range",
  ...
  "cross-axis-mapping.delete": "Supprimer une correspondance d'axes",
  ...
  "cross-axis-mapping.new": "Nouvelle correspondance d'axes",
  "cross-axis-mapping.title": "Correspondance d'axes",
  "cross-axis-mapping.undo.add": "ajouter une correspondance d'axes",
  "cross-axis-mapping.undo.delete": "supprimer une correspondance d'axes",
  "cross-axis-mapping.undo.reorder": "réordonner une correspondance d'axes",
  ...
  "dialog.cant-edit-glyph.content.location-not-at-source-for-glyphs":
    "La localisation n'est pas sur une source pour les glyphes: %0",
  ...
  "dialog.cant-edit-kerning.title": "Ne peut pas éditer le kerning",
  "dialog.cant-edit-sidebearings.title": "Ne peut pas éditer les approches",
  "dialog.create": "Créer",
  ...
  "edit-tools-pen.undo.insert-handles": "Insérer un point de contrôle",
  ...
  "edit-tools-pointer.undo.rotate-selection": "Rotation de la sélection",
  "edit-tools-pointer.undo.toggle-smooth": "Toggle Smooth",
  "editor.hand-tool": "Outil de déplacement",
  "editor.kerning-tool": "Outil de kerning",
  ...
  "plugin-manager.add-plugin-dialog.label.path": "Chemin de l'extension:",
  "plugin-manager.add-plugin-dialog.title": "Ajouter une extension",
  ...
  "sidebar.designspace-navigation.hidden-font-axes": "Axes cachés de la fonte",
  ...
  "sidebar.font-overview.font-source": "Source de la fonte",
  ...
  "sidebar.selection-info.kern-group-l-r": "Groupe de kerning G/D",
  ...
  "sidebar.text-entry.direction.left-to-right": "Gauche à droite",
  "sidebar.text-entry.direction.right-to-left": "Droite à gauche",
  ...
  "sidebar.user-settings.glyph.kerning-tool": "Kerning (Outil)",
