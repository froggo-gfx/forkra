...
/**
 * Compute intersections between the incoming curve to Point A (prev→A)
 * and the straight segment B–C in a four-point configuration.
 *
 * @param {number[]} selection - Array of selected point indices
 * @param {VarPackedPath} path - The path object
 * @returns {Object[]} Array of virtual point objects representing intersection points
 */
